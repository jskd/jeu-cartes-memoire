...
public class CardFragment extends android.app.Fragment {
    ...
    public static CardFragment newInstance(String question) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView text_question = (TextView) v.findViewById(R.id.textView_question);
        text_question.setText(this.question);
